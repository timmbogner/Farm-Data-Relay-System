...
#if defined(TOPIC_DATA_BACKLOG)
#define FDRS_TOPIC_DATA_BACKLOG TOPIC_DATA_BACKLOG
#else
#define FDRS_TOPIC_DATA_BACKLOG GLOBAL_TOPIC_DATA_BACKLOG
#endif // TOPIC_DATA_BACKLOG
